...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const systemPrompt = `You are ORCA (Marine EcOsystem Reasoning with Collaborative Agents), an operational maritime intelligence assistant developed for ISRO SIH26176.
