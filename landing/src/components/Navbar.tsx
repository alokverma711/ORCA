...
// Fixed & verified 3 primary sections in exact page order
...
export function Navbar() {
  ...
  useEffect(() => {
    ...
    const updateActiveSection = () => {
      ...
      // 2. Bottom of page (within 100px of footer): always System Architecture
      ...
      const sectionIds = ['how-it-works', 'problem'];
      ...
      <div className="fixed top-0 left-0 right-0 z-50 pointer-events-none flex justify-center">
        ...
        >
          ...
          <div className="flex h-8.5 items-center justify-between gap-2.5 sm:gap-4 px-1">
            ...
            {/* 1. Left Logo Slot: Custom Logo + ORCA */}
            <button
              type="button"
